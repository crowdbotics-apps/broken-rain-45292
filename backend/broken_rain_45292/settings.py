"""
Django settings for broken_rain_45292 project.
...
ROOT_URLCONF = 'broken_rain_45292.urls'
...
WSGI_APPLICATION = 'broken_rain_45292.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "broken_rain_45292 API",
    "DESCRIPTION": "API documentation for broken_rain_45292 App",
    "VERSION": "v1",
}
